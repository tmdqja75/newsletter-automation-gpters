...
from ..tools.content_tools import fetch_article_content, fetch_official_blog_posts
...
research_subagent = {
    ...
    "tools": [search_ai_news, search_hackernews, fetch_article_content, fetch_official_blog_posts],
}
